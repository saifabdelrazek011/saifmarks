export const resetPasswordEmail = (code, frontendUrl) => {
  const html = `
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Reset Your Password - SaifMarks</title>
    <style>
      body {
  ...
  <body>
    <div class="container">
      ...
      <div class="content">
        ...
        <p>
          We received a request to reset your SaifMarks account password. Use the code below to proceed:
        </p>
        ...
        <p>
          <a href="${frontendUrl}/reset-password" class="cta-button">Reset Password Now</a>
        </p>

        <div class="notice-box">
          <p><strong>How to reset:</strong> Enter the code above on the <a href="${frontendUrl}/reset-password">reset password page</a>, or click the button.</p>
        </div>
